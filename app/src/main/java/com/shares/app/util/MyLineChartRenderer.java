...
public class MyLineChartRenderer extends AbstractChartRenderer {
    ...
    private boolean isDelayHide=false;
    ...
    public MyLineChartRenderer(Context context, Chart chart, MyLineChartDataProvider dataProvider) {
        super(context, chart);
    ...
    public void setDelayHide(boolean delayHide) {
        isDelayHide = delayHide;
    }
